...
if(isset($_POST['submit'])) {
	...
	if($errors['login'] == '' && $errors['password'] == '' && $errors['password_again'] == '') {
		...
		if($reg === true) {
			$message = '<p>Вы успешно зарегистрировались в системе. Сейчас вы будете переадресованы к странице авторизации. Если это не произошло, перейдите на неё по <a href="loginn.php">прямой&nbsp;ссылке</a>.</p>';
